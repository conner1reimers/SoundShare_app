  ...
  return (
    <div className="terms-conditions">
      ...
      Users are responsible for any third-party Personal Data obtained, published or shared through this Application and confirm that they have the third {`party's consent to provide the Data to the Owner.`}
        ...
        The Data processing is carried out using computers and/or IT enabled tools, following organizational procedures and modes strictly related to the purposes indicated. In addition to the Owner, in some cases, the Data may be accessible to
        certain types of persons in charge, involved with the operation of this Application (administration, sales, marketing, legal, system administration) or external parties (such as third-party technical service providers, mail carriers, hosting providers,
        IT companies, communications agencies) appointed, if necessary, as Data Processors by the Owner. The updated list of these parties may be requested from the Owner at any time.
        </div>
        <div className="terms-justify-left">
        ...
        <div>
            ...
            Users have given their consent for one or more specific purposes. Note: Under some legislations the Owner may be allowed to process Personal Data until the User objects to such processing (“opt-out”), without having to rely on
            consent or any other of the following legal bases. This, however, does not apply, whenever the processing of Personal Data is subject to European data protection law;
        ...
        <div>Personal Data is collected for the following purposes and using the following services: Access to third-party accounts: This type of service allows this Application to access Data from your account on a third-party service and perform actions with it.
          ...
          Place of processing: United States – Privacy Policy. (https://www.facebook.com/policy.php)</div>
        ...
        <div>
          ...
          Place of processing: United States – Privacy Policy – Opt Out. (https://policies.google.com/privacy)
        </div>

        <div className="terms-bold">The rights of Users</div>

        <div>Users may exercise certain rights regarding their Data processed by the Owner.
        ...
        <div className="terms-bold">Additional information about Data collection and processing</div>
        <div>
        Legal action
        ...
        <div className="terms-bold">Definitions and legal references</div>
