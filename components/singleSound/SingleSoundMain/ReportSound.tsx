...
const ReportSound: React.FC<Props> = ({id, close}) => {
    ...
    const submit = async (e: any) => {
        ...
        try {
            response = await sendRequest(`${process.env.NEXT_PUBLIC_REACT_APP_MY_ENV}/sounds/report-sound/${userId}/${id}`, 'POST', 
            JSON.stringify({
